...
class PracticalsController extends AppController
{
    ...
    public function add()
    {
        ...
        $subjects = $this->Practicals->Subjects->find('list', ['limit' => 200]);
        $centres = $this->Practicals->Centres->find('list', ['limit' => 200]);
        $this->set(compact('practical', 'subjects', 'centres'));
    }
