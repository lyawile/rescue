...
class CandidatesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'candidates_ibfk_1' => ['type' => 'foreign', 'columns' => ['centres_id'], 'references' => ['centres', 'id'], 'update' => 'cascade', 'delete' => 'restrict', 'length' => []],
            'candidates_ibfk_2' => ['type' => 'foreign', 'columns' => ['exam_types_id'], 'references' => ['exam_types', 'id'], 'update' => 'cascade', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
