...
class PracticalsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'practicals_ibfk_1' => ['type' => 'foreign', 'columns' => ['centre_id'], 'references' => ['centres', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
            'practicals_ibfk_2' => ['type' => 'foreign', 'columns' => ['subject_id'], 'references' => ['subjects', 'id'], 'update' => 'cascade', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
