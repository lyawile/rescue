...
/**
 * CandidateQualificationsFixture
 *
 */
class CandidateQualificationsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'candidate_qualifications_ibfk_1' => ['type' => 'foreign', 'columns' => ['candidates_id'], 'references' => ['candidates', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
