...
class DisqualifiedCandidatesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'work_experience' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'subjects' => ['type' => 'string', 'length' => 256, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'disabilities' => ['type' => 'string', 'length' => 64, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'reason' => ['type' => 'string', 'length' => 256, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'sifa' => ['type' => 'string', 'length' => 128, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'disqualified_candidates_ibfk_1' => ['type' => 'foreign', 'columns' => ['centre_id'], 'references' => ['centres', 'id'], 'update' => 'cascade', 'delete' => 'restrict', 'length' => []],
            'disqualified_candidates_ibfk_2' => ['type' => 'foreign', 'columns' => ['exam_type_id'], 'references' => ['exam_types', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'disabilities' => 'Lorem ipsum dolor sit amet',
                'reason' => 'Lorem ipsum dolor sit amet',
                'sifa' => 'Lorem ipsum dolor sit amet',
                'exam_type_id' => 1,
                'centre_id' => 1
            ],
        ];
