...
/**
 * DisqualifiedCandidatesFixture
 *
 */
class DisqualifiedCandidatesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'PSLE_number' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'PSLE_year' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'is_repeater' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'exam_types_id' => ['type' => 'index', 'columns' => ['exam_types_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'disqualified_candidates_ibfk_1' => ['type' => 'foreign', 'columns' => ['centres_id'], 'references' => ['centres', 'id'], 'update' => 'cascade', 'delete' => 'restrict', 'length' => []],
            'disqualified_candidates_ibfk_2' => ['type' => 'foreign', 'columns' => ['exam_types_id'], 'references' => ['exam_types', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
